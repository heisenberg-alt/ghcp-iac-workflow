...
"@
    Write-ColorLine $logo -Color Cyan
    ...
    $subtitle = @"
     ...
     ╚══════════════════════════════════════════════════════╝
"@
    Write-ColorLine $subtitle -Color Magenta
    Write-Host ""
}
...
function Show-TerraformLogo {
    ...
    ╚══██╔══╝██╔════╝██╔══██╗██╔══██╗██╔══██╗██╔════╝██╔═══██╗██╔══██╗████╗ ████║
       ...
       ╚═╝   ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝      ╚═════╝ ╚═╝  ╚═╝╚═╝     ╚═╝
"@
    Write-ColorLine $logo -Color Magenta
}
...
"@
    Write-ColorLine $logo -Color Blue
}
...
"@
    Write-ColorLine $celebrationArt -Color Green
...
function Test-Prerequisites {
  ...
  ╚═══════════════════════════════════════════════════════════════╝
"@
    Write-ColorLine $header -Color Cyan
    Write-Host ""
...
function Start-IaCLab {
    ...
    ╚██████╗╚██████╔╝██║     ██║███████╗╚██████╔╝   ██║   
     ╚═════╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝ ╚═════╝    ╚═╝   
"@
                Write-ColorLine $copilotLogo -Color Green
                Write-Host ""
  ...
  ╚═══════════════════════════════════════════════════════════════╝
"@
                Write-ColorLine $progressHeader -Color Cyan
                Write-Host ""
                $completed = Get-TotalCompleted -Progress $progress
                Write-Host -NoNewline "  "
                Show-ProgressBar -Current $completed -Total 24
...
"@
                Write-ColorLine $thankYou -Color Cyan
                return
            }
        }
    }
